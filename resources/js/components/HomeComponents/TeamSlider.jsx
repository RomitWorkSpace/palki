...
function TestimonialSection() {
    useEffect(() => {
      ...
      const Abhishek = {image: AbhishekShukla, name: 'Mr. Abhishek Shukla', designation: 'Director', intro: 'Graduated in 2016 from IHM Lucknow, Mr. Abhishek gained valuable industrial training experience at Shangri-La Eros Hotel. He further enhanced his business acumen by pursuing an MBA in Family Business Management from S.P. Jain Institute, Mumbai. Currently, overseeing Operations and New Product Development at the company.'}
